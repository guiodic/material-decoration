...
void Button::paint(QPainter *painter, const QRectF &repaintRegion)
{
    ...
    */     
    ...
    painter->drawPath(deco->getRoundedPath(snappedGeometry, (radius-0.7)*!windowIsMaximized(), m_isLeftmost && deco->leftBorderVisible(), m_isRightmost && deco->rightBorderVisible(), false, false));
