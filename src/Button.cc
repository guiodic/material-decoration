...
void Button::paint(QPainter *painter, const QRectF &repaintRegion)
{
    ...
    */     
    ...
    painter->drawPath(deco->getRoundedPath(snappedGeometry, (radius-Material::cornerRadiusAdjustment)*!windowIsMaximized(), m_isLeftmost && deco->leftBorderVisible(), m_isRightmost && deco->rightBorderVisible(), false, false));
