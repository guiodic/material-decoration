...
void TextButton::paintIcon(QPainter *painter, const QRectF &iconRect, const qreal)
{
    ...
    painter->drawText(iconRect.translated(1.0, 0.0), mnemonicFlag | Qt::AlignCenter | Qt::AlignVCenter | Qt::TextSingleLine, m_text); // translating 1 pixel seems the only way to perfetc centering the text.
}
